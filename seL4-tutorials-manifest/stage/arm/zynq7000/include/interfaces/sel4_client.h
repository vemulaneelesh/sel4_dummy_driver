...
static inline int
seL4_ARM_ASIDControl_MakePool(seL4_ARM_ASIDControl service, seL4_Untyped untyped, seL4_CNode root, seL4_Word index, seL4_Uint8 depth)
{
...
static inline int
seL4_TCB_BindNotification(seL4_TCB service, seL4_CPtr notification)
{
...
static inline int
seL4_TCB_UnbindNotification(seL4_TCB service)
{
...
static inline int
seL4_IRQHandler_SetNotification(seL4_IRQHandler service, seL4_CPtr notification)
{
